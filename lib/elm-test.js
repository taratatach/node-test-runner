...
if (args._[0] === 'make') {
    ...
    return Compile.compileAll(
      ...
      .then(function() {
        return Runner.findTests(
          ...
          .then(function(testsAndExactDeps) {
            ...
            const mainFile = Generate.generateMainModule(
              ...
              args.report,
              testFilePaths,
              testsAndExactDeps.tests,
              testsAndExactDeps.exactDeps,
              generatedSrc,
              processes
            );

          // TODO generate Main
          // TODO compile generated Main
  ...
  if (args.watch) {
    ...
    watcher.on('all', function(event, filePath) {
      var testRootDir = Compile.getTestRootDir(projectRootDir);
